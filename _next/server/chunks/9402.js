...
/* harmony export */   "_": () => (/* binding */ TabToggleGroup),
/* harmony export */   "o": () => (/* binding */ TabToggle)
/* harmony export */ });
...
`;
const Inner = styled_components__WEBPACK_IMPORTED_MODULE_1___default()(_pancakeswap_uikit__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z).withConfig({
    componentId: "sc-269a965c-1"
})`
  justify-content: space-between;
  background-color: ${({ theme  })=>theme.colors.input};
  width: 100%;
`;
const TabToggle = styled_components__WEBPACK_IMPORTED_MODULE_1___default()(_pancakeswap_uikit__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z).attrs({
    as: "button"
}).withConfig({
    componentId: "sc-269a965c-2"
})`
  display: inline-flex;
...
/* harmony import */ var views_Info_components_InfoCharts_LineChart__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(30017);
/* harmony import */ var views_Info_components_InfoCharts_BarChart__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(34354);
/* harmony import */ var components_TabToggle__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(29867);
/* harmony import */ var _pancakeswap_localization__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(24953);
/* harmony import */ var utils_formatInfoNumbers__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(84785);
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(74146);
...
const CandleChart = next_dynamic__WEBPACK_IMPORTED_MODULE_8___default()(null, {
    loadableGenerated: {
        modules: [
            "../views/Info/components/InfoCharts/ChartCard/index.tsx -> " + "../CandleChart"
        ]
    },
    ssr: false
});
...
const ChartCard = ({ variant , chartData , tokenData , tokenPriceData ,  })=>{
    ...
    const { t , currentLanguage: { locale  } ,  } = (0,_pancakeswap_localization__WEBPACK_IMPORTED_MODULE_5__/* .useTranslation */ .$G)();
    ...
    const formattedTvlData = (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(()=>{
        if (chartData) {
            return chartData.map((day)=>{
                return {
                    time: (0,date_fns__WEBPACK_IMPORTED_MODULE_7__.fromUnixTime)(day.date),
    ...
    const getLatestValueDisplay = ()=>{
        ...
        if (hoverValue) {
            valueToDisplay = (0,utils_formatInfoNumbers__WEBPACK_IMPORTED_MODULE_6__/* .formatAmount */ .d)(hoverValue);
        } else if (view === ChartView.VOLUME && formattedVolumeData.length > 0) {
            valueToDisplay = (0,utils_formatInfoNumbers__WEBPACK_IMPORTED_MODULE_6__/* .formatAmount */ .d)(formattedVolumeData[formattedVolumeData.length - 1]?.value);
        } else if (view === ChartView.LIQUIDITY && formattedTvlData.length > 0) {
            valueToDisplay = (0,utils_formatInfoNumbers__WEBPACK_IMPORTED_MODULE_6__/* .formatAmount */ .d)(formattedTvlData[formattedTvlData.length - 1]?.value);
        } else if (view === ChartView.PRICE && tokenData?.priceUSD || tokenData?.priceUSD === 0) {
            valueToDisplay = (0,utils_formatInfoNumbers__WEBPACK_IMPORTED_MODULE_6__/* .formatAmount */ .d)(tokenData.priceUSD, {
                notation: "standard"
            });
        }
        return valueToDisplay ? /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_pancakeswap_uikit__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z, {
            fontSize: "24px",
            bold: true,
            children: [
                "$",
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_pancakeswap_uikit__WEBPACK_IMPORTED_MODULE_11__/* ["default"] */ .Z, {
        children: [
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(components_TabToggle__WEBPACK_IMPORTED_MODULE_4__/* .TabToggleGroup */ ._, {
                children: [
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(components_TabToggle__WEBPACK_IMPORTED_MODULE_4__/* .TabToggle */ .o, {
                    ...
                    variant === "token" && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(components_TabToggle__WEBPACK_IMPORTED_MODULE_4__/* .TabToggle */ .o, {
            ...
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_pancakeswap_uikit__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z, {
                ...
                children: view === ChartView.LIQUIDITY ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(views_Info_components_InfoCharts_LineChart__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, {
                    data: formattedTvlData,
                    setHoverValue: setHoverValue,
                    setHoverDate: setHoverDate
                }) : view === ChartView.VOLUME ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(views_Info_components_InfoCharts_BarChart__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z, {
