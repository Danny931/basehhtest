...
/* harmony import */ var next_dist_server_web_adapter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(83);
        ...
        var mod = __webpack_require__(750)
...
/* harmony export */ });
/* harmony import */ var next_server__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(253);
...
async function middleware(req) {
    ...
    const shouldBlock = BLOCK_COUNTRIES[country] || BLOCK_REGIONS[`${country}-${region}`];
    if (shouldBlock) {
        return next_server__WEBPACK_IMPORTED_MODULE_0__.NextResponse.redirect(new URL("/451", req.url));
    }
    return res;
}
const config = {
...
var _addPathPrefix = __webpack_require__(59);
var _pathHasPrefix = __webpack_require__(847);
...
var _parsePath = __webpack_require__(699);
...
var _removeTrailingSlash = __webpack_require__(822);
var _addPathPrefix = __webpack_require__(59);
var _addPathSuffix = __webpack_require__(705);
...
var _normalizeLocalePath = __webpack_require__(942);
var _removePathPrefix = __webpack_require__(488);
var _pathHasPrefix = __webpack_require__(847);
...
var _relativizeUrl = __webpack_require__(635);
var _nextUrl = __webpack_require__(971);
var _internalUtils = __webpack_require__(307);
...
var _detectDomainLocale = __webpack_require__(242);
var _formatNextPathnameInfo = __webpack_require__(421);
var _getHostname = __webpack_require__(830);
var _getNextPathnameInfo = __webpack_require__(286);
...
const serverExports = {
  ...
  userAgentFromString: (__webpack_require__(637)/* .userAgentFromString */ .Nf),
  userAgent: (__webpack_require__(637)/* .userAgent */ .WE),
}
